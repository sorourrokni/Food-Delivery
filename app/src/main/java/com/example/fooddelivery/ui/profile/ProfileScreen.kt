...
@Composable
fun ProfileScreen(person: Person, name:String, modifier: Modifier=Modifier,address: Address) {
    ...
    Column() {
        ...
        ProfileCard(person = person,Modifier.padding(start = 42.dp,end=57.dp),address=address)
