...
fun HistoryPage(payment_list:ArrayList<Payment>, modifier: Modifier = Modifier){
    ...
    Column(
            ...
            Row(
                ...
                Text(
                    text = "History", style = MaterialTheme.typography.displayLarge,color=Color.Black
                )
            }
            Row(
                horizontalArrangement = Arrangement.SpaceBetween,
